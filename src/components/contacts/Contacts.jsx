      ...
      <div className="contact-info">
        <div className="contact-info-one">
          ...
          <p>
            ...
            the restaurant's chef <br />
            and co-owner, winner of several international culinary competitions.
            <br /> According to him, it combines the best products in a way that
            is understandable to the gourmets <br />
